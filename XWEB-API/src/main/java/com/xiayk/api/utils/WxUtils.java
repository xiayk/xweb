...
import com.xiayk.api.common.WeChatUrl;
...
public class WxUtils {
    ...
    private final static String WX_MIN_APPID = "wx45c99973f70022ec";

    private final static String WX_MIN_SECRET = "cc68e67b17d2becafd1669a6333a1012";

    private final static String WX_MIN_GRANT_TYPE = "authorization_code";
    /**
     * 请求微信后台获取用户数据
    ...
    public static String jscode2session(String code)throws Exception{
        ...
        params.put("appid",WX_MIN_APPID);
        params.put("secret",WX_MIN_SECRET);
        params.put("js_code",code);
        params.put("grant_type",WX_MIN_GRANT_TYPE);
        //设置编码
        log.info("WXJSON params ==> {}", params);
        return HttpUtil.sendPost(WeChatUrl.JS_CODE_2_SESSION.getUrl(), params);
    }
